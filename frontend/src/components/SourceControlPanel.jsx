  ...
  return (
    <div className={`scm-change-row vscode-scm-row ${selected ? "selected" : ""}`}>
      ...
      <div className="scm-row-actions">
        ...
        {proposal && (conflict || change.review_status === "FAIL") && <button title="Override and Apply" onClick={() => onRun(() => api.proposalOverrideApply(change.project, change.proposal_id, change.path), `Override applied ${change.path}`)}><ShieldAlert size={14} /></button>}
