...
export default function CommandPalette() {
  ...
  const commands = useMemo(
    () => [
      ...
      { label: "Source Control: Refresh from JSON", run: () => loadWorktree(currentProject) },
      { label: "Source Control: Scan Disk for Changes", run: () => refreshWorktreeFromJson?.({ forceTree: true, scanDisk: true }) },
